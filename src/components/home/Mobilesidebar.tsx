    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col mt-6 space-y-2 px-6">
          ...
          <a href="#" className="py-2 px-2 rounded text-gray-700 font-medium hover:bg-teal-50 hover:text-teal-700" onClick={() => setSidebarOpen(false)}>Tentang Pesantren</a>
          <a href="#" className="py-2 px-2 rounded text-gray-700 font-medium hover:bg-teal-50 hover:text-teal-700" onClick={() => setSidebarOpen(false)}>Visi Misi</a>
          <a href="#" className="py-2 px-2 rounded text-gray-700 font-medium hover:bg-teal-50 hover:text-teal-700" onClick={() => setSidebarOpen(false)}>Galery Kegiatan</a>
          <Link href="/fintren" className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-teal-600 hover:to-teal-700 transition-all duration-300 shadow-md text-center" onClick={() => setSidebarOpen(false)}>Fintren</Link>
        </nav>
